...
class GameController {
  ...
  static Future<int> startNewRound(int roundNumber, int hiddenBy, int rangeLimit) async {
    final random = Random();
  ...
  static Future<List<Map<String, dynamic>>> getPlayerGuesses(int playerId) async {
    if (_currentRoundId == null) return [];
    return await _dbHelper.getGuessesForRound(_currentRoundId!)
        .then((guesses) => guesses.where((g) => g['player_id'] == playerId).toList());
  }
